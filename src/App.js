...
function App() {
  ...
  const SEARCH_API = basePath + "search/movie";
  const DISCOVER_API = basePath + "discover/movie";
  ...
  const fetchMovie = async (id) => {
    const { data } = await axios.get(`${basePath}movie/${id}`, {
      params: {
        api_key: API_KEY,
                  ...
                  <div className="poster-content">
                    {trailer ? (
                      <button
                        ...
                        type="button"
                      >
                        Play Trailer <i class="fa-solid fa-play"></i>
                      </button>
                    ) : (
